	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuarioInstance?.idUsuario}">
				<li class="fieldcontain">
					<span id="idUsuario-label" class="property-label"><g:message code="usuario.idUsuario.label" default="Id Usuario" /></span>
					
						<span class="property-value" aria-labelledby="idUsuario-label"><g:fieldValue bean="${usuarioInstance}" field="idUsuario"/></span>
